...
.how-to-use-it {
  ...
  .wrapper {
    @include flex.flex-row(flex-start, stretch, nowrap, 2rem);
    margin-top: 2rem;

    @media (max-width: breakpoints.$breakpoint-lg) {
      @include flex.flex-column(flex-start, stretch, nowrap, 1.5rem);
    }
  ...
  .stepsNumber-container {
    @include flex.flex-column(flex-start, stretch, nowrap, 1rem);
    min-width: 200px;

    @media (max-width: breakpoints.$breakpoint-lg) {
      @include flex.flex-row(flex-start, stretch, wrap, 0.5rem);
      min-width: auto;
    }
