...
onMounted(() => {
  ...
  // Play ambient sound (low volume)
  if (audioRef.value) {
    audioRef.value.volume = 0.15
    audioRef.value.play().catch(() => {
      // Handle autoplay restrictions or missing audio files gracefully
      console.log('Audio autoplay prevented by browser or audio file not found')
    })
  }
})
</script>
...
<template>
  <main class="about-page">
    ...
    <audio ref="audioRef" loop>
      ...
      <source src="/ambient-sound.mp3" type="audio/ogg">
    </audio>
    ...
    <section class="hero-section" :class="{ 'loaded': isLoaded }">
      <div class="hero-content">
        ...
        <p class="hero-description">
          We are the creative minds behind innovative digital experiences.
